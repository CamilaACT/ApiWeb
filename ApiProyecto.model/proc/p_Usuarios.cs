...
namespace ApiProyecto.model.proc
{
    public class p_Usuarios
    {
        ...
        public static Respuesta registar(Request.Usuario usuarioa)
        {
            ...
            try
            {
                ...
                cb.sp = "usp_Web_usuarios_G_usuario";//poner el nombre correcto
        ...
        public static Respuesta modificar(Request.Usuario usuarioa)
        {
            ...
            try
            {
                ...
                vector[0] = "@usu_id,i," + usuarioa.idUsuario;
        ...
        public static Respuesta buscar(Usuario_nombre usu_nom)
        {
            ...
            try
            {
                ...
                vector[0] = "@usu_nombre,v," + usu_nom.nombre;
                dt = cb.consultar(vector, 1, strCon);
                res.CodigoError = cb.valo_erro;
                if (res.CodigoError == -1)
                {
        ...
        public static Respuesta eliminar(int usu_id)
        {
            ...
            try
            {
                ...
                string strCon = util.Conexion.Conexion.CadenaConexion();
                string[] vector = new string[1];
                cb.sp = "usp_Web_usuarios_E_eliminar";//poner el nombre correcto
